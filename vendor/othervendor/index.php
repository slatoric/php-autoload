<?php
namespace lib;//namespace from root directory of site

require_once(dirname(__FILE__)."/ald.php");//adds root directory to include_path and registers standart autoloader
